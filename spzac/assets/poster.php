    ...
    function show_comiis_poster_ykzn(){
        if(comiis_poster_start_wlat == 0){
            ...
            var html = '<div id="comiis_poster_box" class="comiis_poster_nchxd">\n' +
                ...
                '<div class="comiis_poster_img"><div class="img_time"><?php $this->date('d'); ?><span><?php $this->date('Y'); ?>/<?php $this->date('m'); ?></span></div><img src="<?php $this->fields->img(); ?>" class="vm" id="comiis_poster_image"></div>\n' +
