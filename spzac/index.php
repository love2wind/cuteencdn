...
<?php endif; ?>
				...
				<div class="col-12 col-md-7 col-lg-8 col-xl-6">
                   ...
                   <ul class="nav nav-tabs main__nav" id="main__nav" role="tablist">
						<li class="nav-item">
							<a class="nav-link active" id="btnon" data-toggle="tab" href="#tab-1" role="tab" aria-controls="tab-1" aria-selected="true">文章推荐</a>
						</li>
   ...
   // }     
    ...
    ?>
                            ...
                            <div class="main__box">
								...
								<h3 class="main__box-title">FAQ 常见问题</h3>
