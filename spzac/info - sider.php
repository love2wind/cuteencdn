...
<!--<div class="sidebox__more">网站简介</div>-->
					...
					<div class="sidebox sidebox--desk fixside" style="z-index:1;">
						<h4 class="sidebox__title">目 录</h4>
...
<!--<div class="sidebox__more">网站简介</div>-->
				...
				<div class="sidebox sidebox__ad sidebox--desk"><?php $this->options->adimg(); ?></div>  
...
<?php if ($this->is('index')): ?>  
					...
					<div class="sidebox sidebox--desk  <?php if ($this->is('index')): ?>fixside<?php endif; ?> " >
						...
						<a href="https://love2wind.cn/category/niepan/" class="sidebox__more">View more</a>
					</div>
					<!-- end sidebox -->
