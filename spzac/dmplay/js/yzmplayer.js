						...
						if (this.showing) {
							...
							for (var u = document.createDocumentFragment(), d = 0; d < e.length; d++) ! function(a) {
								...
								o.classList.add("yzmplayer-danmaku-item"), o.classList.add("yzmplayer-danmaku-" + e[a].type), e[a].border ?
									...
									e[a].text, o.style.opacity = t._opacity, o.style.color = e[a].color, o.addEventListener(
										"animationend",
										function() {
			...
			o = function() {
				...
				return a(e, [{
					...
					value: function() {
						...
						this.template.infoVersion.innerHTML = "1.1.0", this.template.infoType.innerHTML = this.player.type, this.template
